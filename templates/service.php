		...
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6">
				<div class="media align-items-center mb-4">
				  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/services/service-1.jpg" class="mr-3 w-50" alt="...">
			...
			<div class="col-lg-6 col-md-6 col-sm-6">
				<div class="media align-items-center mb-4">
				  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/services/service-2.jpg" class="mr-3 w-50" alt="...">
			...
			<div class="col-lg-6 col-md-6 col-sm-6">
				<div class="media align-items-center mb-4">
				  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/services/service-3.jpg" class="mr-3 w-50" alt="...">
			...
			<div class="col-lg-6 col-md-6 col-sm-6">
				<div class="media align-items-center mb-4">
				  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/services/service-4.jpg" class="mr-3 w-50" alt="...">
			...
			<div class="col-lg-6 col-md-6 col-sm-6">
				<div class="media align-items-center mb-4">
				  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/services/service-5.jpg" class="mr-3 w-50" alt="...">
			...
			<div class="col-lg-6 col-md-6 col-sm-6">
				<div class="media align-items-center mb-4">
				  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/services/service-6.jpg" class="mr-3 w-50" alt="...">
