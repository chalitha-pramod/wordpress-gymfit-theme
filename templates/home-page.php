...
<section class="slider">
	<div class="container">
		<div class="row">
			<div class="col-md-8">
				<span class="h6 d-inline-block mb-4 subhead text-uppercase"><?php echo the_field('subtitle') ;?></span>
				<h1 class="text-uppercase text-white mb-5">Step up your <span class="text-color"><?php echo the_field('title') ;?></span><br>with us</h1>
			
				<a href="<?php echo the_field('button_url') ;?>" target="_blank" class="btn btn-main " ><?php echo the_field('button_text') ;?> <i class="ti-angle-right ml-3"></i></a>
			</div>
		</div>
	</div>
</section>
...
<section class="section about">
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-6">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/images/bg/bg-5.jpg" alt="" class="img-fluid rounded shadow w-100">
			</div>
	...
	<div class="container-fluid p-0">
		<div class="row no-gutters portfolio-gallery">
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/gallery-01.jpg" class="popup-gallery">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/gallery-01.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/gallery-02.jpg" class="popup-gallery">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/gallery-02.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/gallery-03.jpg" class="popup-gallery">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/gallery-03.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/gallery-04.jpg" class="popup-gallery">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/gallery-04.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/gallery-05.jpg" class="popup-gallery">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/gallery-05.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/gallery-06.jpg" class="popup-gallery">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/gallery-06.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/gallery-07.jpg" class="popup-gallery">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/gallery-07.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/gallery-08.jpg" class="popup-gallery">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/gallery-08.jpg" alt="" class="img-fluid">
				</a>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-3 col-md-6">
				<div class="card border-0 rounded-0 p-0 mb-5 mb-lg-0 shadow-sm">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/course-1.jpg" alt="" class="img-fluid">
			...
			<div class="col-lg-3 col-md-6">
				<div class="card border-0 rounded-0 p-0 mb-5 mb-lg-0 shadow-sm">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/course-2.jpg" alt="" class="img-fluid">
			...
			<div class="col-lg-3 col-md-6">
				<div class="card border-0 rounded-0 p-0 mb-5 mb-lg-0 shadow-sm">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/gallery/course-3.jpg" alt="" class="img-fluid">
