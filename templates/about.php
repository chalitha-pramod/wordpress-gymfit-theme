	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-3 col-md-6">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/images/about/img-6.jpg" alt="" class="img-fluid">
			</div>
			<div class="col-lg-3 mt-lg-4 col-md-6">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/images/about/img-7.jpg" alt="" class="img-fluid">
			</div>
