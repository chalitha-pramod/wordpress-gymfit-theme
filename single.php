...
<section class="section blog bg-gray">
	...
	<div class="media mb-4">
		<img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/blog-post-5.jpg" alt="" class="img-fluid mr-4">
	...
	<article class="card border-0 rounded-0 mb-4">
		<img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/post1.jpg" alt="" class="img-fluid">
...
<div class="col-lg-4 col-md-6">
	<article class="card border-0 rounded-0 mb-4">
		<img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/post2.jpg" alt="" class="img-fluid">
...
<div class="col-lg-4 col-md-6">
	<article class="card border-0 rounded-0">
		<img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/post3.jpg" alt="" class="img-fluid">
	...
	<div class="mt-5 border-bottom pb-5">
		...
		<div class="media">
		  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/post-1.jpg" class="mr-4 img-fluid" alt="...">
		  <div class="media-body">
		    ...
		    <div class="media mt-5">
		      <a class="mr-3" href="#">
		         <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/post-2.jpg" class="mr-4 img-fluid" alt="...">
		      </a>
		      <div class="media-body">
...
<div class="mb-5">
	...
	<div class="media mb-4">
	  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/blog-post-5.jpg" alt="" class="img-fluid pr-4 w-50 align-self-center">
	  <div class="media-body">
	...
	<div class="media mb-4">
	  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/blog-post-6.jpg" alt="" class="img-fluid pr-4 w-50 align-self-center">
	  <div class="media-body">
	...
	<div class="media mb-4">
	  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/post1.jpg" alt="" class="img-fluid pr-4 w-50 align-self-center">
	  <div class="media-body">
	    <a href="#" class="text-black d-block lh-25">Keep your body fitness track</a>
	  </div>
	</div>
